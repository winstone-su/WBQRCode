...
- (void)addLine
{
    ...
    _imgLine.image = [UIImage imageNamed:@"zbar_line"];
    _imgLine.center = CGPointMake(self.transparentArea.size.width/2+CGRectGetMinX(self.transparentArea), _rectY + 2);
...
- (void)addDescView
{
    ...
    LabDesc.center = CGPointMake(self.transparentArea.size.width/2+CGRectGetMinX(self.transparentArea), _rectY + self.transparentArea.size.height + 25.f);
    ...
    [LabDesc setUserInteractionEnabled:YES];
    self.resultLabel = LabDesc;
